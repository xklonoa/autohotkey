...
{
    gui_destroy()
    run chrome.exe --new-window www.reddit.com
}
...
else if Pedersen =  voi ; Open Google Voice in default browser
{
    gui_destroy()
    run https://voice.google.com/u/0/messages
}
else if Pedersen = snip ; opens the snipping tool
{
	gui_destroy()
	run "C:\Windows\system32\SnippingTool.exe"
}
else if Pedersen = ama ; amazon
{ 
    gui_destroy()
    run https://www.amazon.com/
}
else if Pedersen = yout ; youtube
{
    gui_destroy()
    run https://www.youtube.com/
}
else if Pedersen = new ; youtube
{
    gui_destroy()
    run chrome.exe --new-window www.reddit.com
}
...
else if Pedersen = my ; My Computer
{
    gui_destroy()
